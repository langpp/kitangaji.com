    ...
    <div class="row">
      <div class="col-lg-12">
        <h1 class="section-header">
          <div>Rencana Proyek</div>
        </h1>

        <div class="card">
          <div class="card-header">
            <h4>Data Rencana Proyek Terbaru</h4>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="<?php echo base_url();?>dashboard/progressProyek" class="btn btn-action btn-secondary">Detail</a></td>
                </tr>
                <tr>
                  <td>
                   2
