...
<?php if ($this->uri->segment(1) == 'guru' && $this->uri->segment(2) != '') { ?>
<style type="text/css">
.ftco-navbar-light{
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="<?php echo base_url();?>">KitaNgaji.com | Guru</a>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav nav ml-auto menusBar">
					<li class="nav-item"><a href="<?php echo base_url();?>guru" <?php if ($this->uri->segment(1) == 'guru' && $this->uri->segment(2) == '') { ?> class="nav-link active" <?php }else{ ?> class="nav-link"<?php } ?>><span>Beranda</span></a></li>
					<li class="nav-item"><a href="<?php echo base_url();?>guru/jadwalKbm" <?php if ($this->uri->segment(1) == 'guru' && $this->uri->segment(2) == 'jadwalKbm' || $this->uri->segment(1) == 'guru' && $this->uri->segment(2) == 'detail') { ?> class="nav-link active" <?php }else{ ?> class="nav-link"<?php } ?>><span>Jadwal KBM</span></a></li>
					<li class="nav-item"><a href="<?php echo base_url();?>guru/laporanKbm" <?php if ($this->uri->segment(1) == 'guru' && $this->uri->segment(2) == 'laporanKbm') { ?> class="nav-link active" <?php }else{ ?> class="nav-link"<?php } ?>><span>Laporan KBM</span></a></li>
					<li class="nav-item dropdown">
						<a <?php if ($this->uri->segment(1) == 'guru' && $this->uri->segment(2) == 'invoice' || $this->uri->segment(1) == 'guru' && $this->uri->segment(2) == 'laporanKeuangan') { ?> class="nav-link active dropdown-toggle" <?php }else{ ?> class="nav-link dropdown-toggle" <?php } ?> href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							Keuangan
						</a>
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="<?php echo base_url();?>guru/invoice">Invoice</a>
							<a class="dropdown-item" href="<?php echo base_url();?>guru/laporanKeuangan">Laporan Keuangan</a>
						</div>
					</li>
					<li class="nav-item dropdown">
						<a <?php if ($this->uri->segment(1) == 'guru' && $this->uri->segment(2) == 'profile') { ?> class="nav-link active dropdown-toggle" <?php }else{ ?> class="nav-link dropdown-toggle" <?php } ?> href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							Hi, Guru
						</a>
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="<?php echo base_url();?>guru/profile">Profile</a>
