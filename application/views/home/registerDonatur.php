      ...
      <div class="card border-success">
        <div class="card-body">
          <form class="form-signin">
            <h5 class="mb-3 text-center">Daftar Menjadi Donatur</h5>
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                ...
                <div class="form-group">
                  <label class="text-left">Profesi</label>
                ...
                <div class="form-group">
                  <label class="text-left">Penghasilan Perbulan</label>
                  <select class="form-control">
                    <option hidden="">Silahkan Pilih</option>
            ...
            <div class="form-group text-center">
              <label class="text-left">Jenis Donatur</label>
              <div class="form-check">
                <label class="form-check-label">
                  <input type="radio" class="form-check-input" name="optradio">Tetap
                </label>
                <label class="form-check-label ml-5">
                  <input type="radio" class="form-check-input" name="optradio">Sukarala
                </label>
              </div>
            </div>
            
            <a class="btn btn-md btn-primary btn-block" href="<?php echo base_url();?>dashboardDonatur">Daftar Sekarang</a>
